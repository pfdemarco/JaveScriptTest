...
$(document).ready(function(){
  ...
  //YOU MAY SEE WEIRD DIFFERENCES BETWEEN THE T AND TIMELEFT THATS BECAUSE WE SUBTRACT 5 FROM TIMELEFT BEFORE IT GETS TO T... FIX!!!
  ...
  //MAYBE PREVENT USER FROM ENTERING THE SAME THING 
  subm.on('click', function(e){//if name is empty or indexnum = 0 then dont do it 
    ...
    if (thename != "") {
     ...
     //have to figure out how to append prepend a new div with the initials and score...
      ...
      div.textContent = "Name: " + thename + " Score: " + timeLeft;
    }
  });
